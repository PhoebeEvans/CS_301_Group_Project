...
public final class FragmentGalleryBinding implements ViewBinding {
  ...
  private FragmentGalleryBinding(@NonNull LinearLayout rootView, @NonNull TextView galleryText) {
  ...
  public static FragmentGalleryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.gallery_text;
      TextView galleryText = ViewBindings.findChildViewById(rootView, id);
      if (galleryText == null) {
        break missingId;
      }

      return new FragmentGalleryBinding((LinearLayout) rootView, galleryText);
    }
